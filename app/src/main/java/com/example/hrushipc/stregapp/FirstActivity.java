...
public class FirstActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button reset, submit,add_btn,remove_btn;
    LinearLayout third_layout,add_layout;
    int no_of_members = 2;
    /**
            ...
            if (!finalMessage.equalsIgnoreCase("")) {
                ...
                StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(FirstActivity.this, "FUCK this" + error.getMessage()  , Toast.LENGTH_LONG).show();
...
/*    @Override
   public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.hrushipc.stregapp/http/host/path")
        );
